...
module SushiMcp
  module Tools
    class SkillsList < BaseTool
      ...
      def description
        'List all available SUSHI skills sections. Use this to see what documentation topics are available before retrieving specific sections.'
      end
      ...
      def call(arguments)
        ...
        if sections.empty?
          return text_content("No skills sections found. Check if skills/sushi.md exists.")
        end

        output = "Available SUSHI Skills Sections:\n\n"
