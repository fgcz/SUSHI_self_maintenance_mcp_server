...
module SushiMcp
  module Tools
    class SkillsGet < BaseTool
      ...
      def description
        'Get the content of a specific SUSHI skills section by ID. Use this after skills_list to retrieve detailed documentation.'
      end
      ...
      def input_schema
        {
          ...
          properties: {
            section_id: {
              type: 'string',
              description: 'The section ID to retrieve (e.g., "ARCH-010", "DEV-020")'
            }
          },
          required: ['section_id']
        }
