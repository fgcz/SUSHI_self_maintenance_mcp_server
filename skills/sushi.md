...
## [META-001] Document Metadata

- **Name**: SUSHI Framework Complete Reference
- **Version**: 1.0.0
- **Purpose**: Unified skills document for SUSHI MCP Server self-maintenance
- **Last Updated**: 2026-01-06
- **Scope**: Installation, Administration, App Development, CLI, Troubleshooting
...
## [META-002] MCP Server Integration Notes
...
| Task | Tool | Section |
|------|------|---------|
| Understanding architecture | `skills_get` | ARCH-010, ARCH-020 |
| Setting up test instance | `skills_get` | DEPLOY-010 |
| Creating new app | `skills_get` | DEV-010 to DEV-060 |
| CLI job submission | `skills_get` | CLI-010 to CLI-030 |
| Troubleshooting | `skills_search` | TROUBLE-* |
| Quick commands | `skills_get` | REF-010 |
